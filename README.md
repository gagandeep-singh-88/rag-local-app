# rag-local-app
This project is a simple Retrieval-Augmented Generation (RAG) based FAQ chatbot that runs entirely on a local machine. It leverages open-source LLMs, specifically the Qwen2.5 1.5B model, to provide accurate answers based on a predefined FAQ dataset.
